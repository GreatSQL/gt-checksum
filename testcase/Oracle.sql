...
-- 修正INSERT语句，移除不存在的NAME列并添加正确的schema
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(1,32,'Beijing',2000.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(2,25,'Shanghai',1500.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(3,23,'Hangzhou',2000.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(4,25,'Henan',6500.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(5,27,'Hunan',8500.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(6,22,'Hunan',4500.00);
INSERT INTO "PCMS"."info"(ID,AGE,ADDRESS,SALARY) VALUES(7,24,'Hebei',10000.00);
...
-- 注意：Oracle触发器中通常不建议使用COMMIT，因为它会干扰触发事务
-- COMMIT;
END;
