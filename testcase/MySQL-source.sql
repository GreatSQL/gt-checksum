-- to be applied in source MySQL instance
SET NAMES utf8mb4;
...
CREATE TABLE testint(
    ...
    f3 MEDIUMINT NOT NULL DEFAULT 0,
    f4 INT UNSIGNED DEFAULT 0,
    f5 INT(5) ZEROFILL,
    f6 INT UNSIGNED,
    f7 BIGINT
) COMMENT='table testint';
ALTER TABLE testint ADD INDEX idx_testint_1(f1);
INSERT INTO testint(f1,f2,f3,f4,f5,f6,f7) VALUES(1,2,3,4,5,6,7), (10,20,30,40,50,60,70);
...
INSERT INTO testbit VALUES(1,31,65), (0, 16, 34);

DROP TABLE IF EXISTS testtime;
CREATE TABLE testtime(
     f1 YEAR,
     f2 YEAR NOT NULL DEFAULT 2025,
     f3 DATE NOT NULL DEFAULT '2025-03-16',
     f4 TIME NOT NULL DEFAULT '10:15:30',
     f5 DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
     f6 TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) COMMENT='table testtime';
...
('DOC-0000000000000002', 'Understanding FULLTEXT', 'Search Engineer', 'InnoDB supports full-text search using inverted indexes.'),
